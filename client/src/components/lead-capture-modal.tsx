...
export default function LeadCaptureModal({ isOpen, onClose }: LeadCaptureModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-brand-bg gradient-border rounded-2xl p-8 m-4 max-w-lg w-full max-h-[95vh] overflow-y-auto">
        {/* Close Button */}
        <button
          type="button"
          onClick={onClose}
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full btn-gradient text-white py-3 rounded-lg font-bold text-base disabled:opacity-50 disabled:cursor-not-allowed transition-all min-h-[44px]"
              >
                {isSubmitting ? "SENDING YOUR GUIDE..." : "GET FREE CONSULTATION GUIDE"}
              </button>
            </form>

            <p className="text-center text-brand-secondary text-sm mt-6 px-2 leading-relaxed">
              📧 Your consultation guide will be emailed instantly.<br />
